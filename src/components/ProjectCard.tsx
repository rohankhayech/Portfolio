        ...
        <Card style={{ height: '100%', width: '100%' }} variant="outlined">
            <CardContent style={{ height: '100%' }}>
                <Stack style={{ height: '100%' }} direction="column" justifyContent="space-between" spacing={2}>
                    ...
                    <Stack direction="column" spacing={1}>
                        <TagChipGroup items={project.langs} keyPrefix="lg" title="Languages" leadingIcon="data_object"/>
                        <TagChipGroup items={project.platforms} keyPrefix="pf" title="Platforms" leadingIcon="devices" />
                        <TagChipGroup items={project.frameworks} keyPrefix="fw" title="Frameworks/Libraries" leadingIcon="dynamic_form" />
                    </Stack>
                </Stack>
            </CardContent>
        </Card>
